...
class ZebraDataWedgeController {
  ...
  Future<bool> get isControllerSupported async => (!kIsWeb && Platform.isAndroid) && await ZebraInterface.isControllerSupported;
  ...
  Future<dynamic> get imei async => await ZebraInterface.imei;
